(function(P){typeof define=="function"&&define.amd?define(P):P()})((function(){"use strict";function P(r){if(r&&r.length){const t=r.lastIndexOf(".");return t!==-1&&(r=r.slice(t).toLowerCase()),r}return""}async function Vt(r){const t=r.items;let i=[],e=[];for(let n=0;n<t.length;n++)e.push(t[n].webkitGetAsEntry());for(;e.length>0;){let n=e.shift();n.isFile?i.push(n):n.isDirectory&&e.push(...await Ot(n.createReader()))}return i}async function Ot(r){let t=[],i=await R(r);for(;i.length>0;)t.push(...i),i=await R(r);return t}async function R(r){try{return await new Promise((t,i)=>{r.readEntries(t,i)})}catch(t){console.log(t)}}async function Gt(r,t){return new Promise(i=>{let e=new FileReader;e.addEventListener("loadend",n=>{i(n.target.result)}),t?e.readAsText(r):e.readAsArrayBuffer(r)})}async function vt(r,t){return new Promise(i=>r.file(async e=>i(await Gt(e,t))))}const Kt=new TextDecoder,jt=new TextEncoder;function O(r){return Kt.decode(r)}function G(r){return jt.encode(r)}function Nt(r){return r instanceof Uint8Array?r:typeof r=="string"?G(r):new Uint8Array(r)}function Rt(r,t,i=0,e=1/0){const n=Math.max(i,0),o=Math.min(n+e,r.length);let s=0,c=t.charCodeAt(0);for(let h=n;h<o;h++)if(r[h]===c){if(s+=1,s===t.length)return!0;c=t.charCodeAt(s)}else s>0&&(s=0,c=t.charCodeAt(0));return!1}function Dt(r,t,i=0,e=1/0){const n=Math.max(i,0),o=Math.min(n+e,r.length);let s=0,c=t[0];for(let h=n;h<o;h++)if(r[h]===c){if(s+=1,s===t.length)return!0;c=t[s]}else s>0&&(s=0,c=t[0]);return!1}function $t(r,t,i=0,e=1/0){const n=Math.max(i,0),o=Math.min(n+e,r.length);for(let s=n;s<o;s++)if(r[s]===t)return s;return-1}const k=new ArrayBuffer(8),D=new Int8Array(k),$=new Int16Array(k),q=new Int32Array(k),l=new Uint8Array(k),H=new Uint16Array(k),z=new Uint32Array(k),X=new Float32Array(k),W=new Float64Array(k);function Z(r){return l[0]=r,D[0]}function Y(r,t){return l[0]=r,l[1]=t,$[0]}function Q(r,t,i,e){return l[0]=r,l[1]=t,l[2]=i,l[3]=e,q[0]}function _(r,t){return l[0]=r,l[1]=t,H[0]}function J(r,t,i,e){return l[0]=r,l[1]=t,l[2]=i,l[3]=e,z[0]}function m(r,t,i,e){return l[0]=r,l[1]=t,l[2]=i,l[3]=e,X[0]}function tt(r,t,i,e,n,o,s,c){return l[0]=r,l[1]=t,l[2]=i,l[3]=e,l[4]=n,l[5]=o,l[6]=s,l[7]=c,W[0]}function it(r){return l[0]=r,D[0]}function et(r,t){return $[0]=t,r[0]=l[0],r[1]=l[1],r}function nt(r,t){return q[0]=t,r[0]=l[0],r[1]=l[1],r[2]=l[2],r[3]=l[3],r}function rt(r,t){return H[0]=t,r[0]=l[0],r[1]=l[1],r}function st(r,t){return z[0]=t,r[0]=l[0],r[1]=l[1],r[2]=l[2],r[3]=l[3],r}function ot(r,t){return X[0]=t,r[0]=l[0],r[1]=l[1],r[2]=l[2],r[3]=l[3],r}function at(r,t){return W[0]=t,r[0]=l[0],r[1]=l[1],r[2]=l[2],r[3]=l[3],r[4]=l[4],r[5]=l[5],r[6]=l[6],r[7]=l[7],r}const a=new Uint8Array(8);class C{buffer;uint8array;index=0;byteLength;remaining;constructor(t,i,e){const n=Nt(t);i=i||0,e=e||n.length,this.buffer=t,this.uint8array=n.subarray(i,i+e),this.byteLength=e,this.remaining=e}substream(t){if(this.remaining<t)throw new Error(`ByteStream: substream: want ${t} bytes but have ${this.remaining}`);const i=this.index;return this.index+=t,new C(this.uint8array.subarray(i,i+t))}skip(t){if(this.remaining<t)throw new Error(`ByteStream: skip: premature end - want ${t} bytes but have ${this.remaining}`);this.index+=t,this.remaining-=t}seek(t){this.index=t,this.remaining=this.byteLength-t}read(t){if(this.remaining<t)throw new Error(`ByteStream: read: premature end - want ${t} bytes but have ${this.remaining}`);const i=this.uint8array,e=this.index;let n=$t(i,0,e,t);return n===-1&&(n=e+t),this.index+=t,this.remaining-=t,O(i.subarray(e,n))}readNull(){if(this.remaining<1)throw new Error("ByteStream: readNull: premature end - want at least 1 byte but have 0");const t=this.uint8array,i=this.index;let e=t.indexOf(0,i);e===-1&&(e=t.length-1);const n=e-i+1;return this.index+=n,this.remaining-=n,O(t.subarray(i,e))}readBinary(t){if(this.remaining<t)throw new Error(`ByteStream: readBinary: premature end - want ${t} bytes but have ${this.remaining}`);const i=this.uint8array,e=this.index;let n="";for(let o=0;o<t;o++)n+=String.fromCharCode(i[e+o]);return this.index+=t,this.remaining-=t,n}readInt8(){if(this.remaining<1)throw new Error(`ByteStream: readInt8: premature end - want 1 byte but have ${this.remaining}`);const t=this.index,i=this.uint8array,e=Z(i[t]);return this.index+=1,this.remaining-=1,e}readInt16(){if(this.remaining<2)throw new Error(`ByteStream: readInt16: premature end - want 2 bytes but have ${this.remaining}`);const t=this.index,i=this.uint8array,e=Y(i[t],i[t+1]);return this.index+=2,this.remaining-=2,e}readInt32(){if(this.remaining<4)throw new Error(`ByteStream: readInt32: premature end - want 4 bytes but have ${this.remaining}`);const t=this.index,i=this.uint8array,e=Q(i[t],i[t+1],i[t+2],i[t+3]);return this.index+=4,this.remaining-=4,e}readUint8(){if(this.remaining<1)throw new Error(`ByteStream: readUint8: premature end - want 1 byte but have ${this.remaining}`);const t=this.uint8array[this.index];return this.index+=1,this.remaining-=1,t}readUint16(){if(this.remaining<2)throw new Error(`ByteStream: readUint16: premature end - want 2 bytes but have ${this.remaining}`);const t=this.index,i=this.uint8array,e=_(i[t],i[t+1]);return this.index+=2,this.remaining-=2,e}readUint32(){if(this.remaining<4)throw new Error(`ByteStream: readUint32: premature end - want 4 bytes but have ${this.remaining}`);const t=this.index,i=this.uint8array,e=J(i[t],i[t+1],i[t+2],i[t+3]);return this.index+=4,this.remaining-=4,e}readFloat32(){if(this.remaining<4)throw new Error(`ByteStream: readFloat32: premature end - want 4 bytes but have ${this.remaining}`);const t=this.index,i=this.uint8array,e=m(i[t],i[t+1],i[t+2],i[t+3]);return this.index+=4,this.remaining-=4,e}readFloat64(){if(this.remaining<8)throw new Error(`ByteStream: readFloat64: premature end - want 8 bytes but have ${this.remaining}`);const t=this.index,i=this.uint8array,e=tt(i[t],i[t+1],i[t+2],i[t+3],i[t+4],i[t+5],i[t+6],i[t+7]);return this.index+=8,this.remaining-=8,e}readInt8Array(t){if(ArrayBuffer.isView(t)||(t=new Int8Array(t)),this.remaining<t.byteLength)throw new Error(`ByteStream: readInt8Array: premature end - want ${t.byteLength} bytes but have ${this.remaining}`);const i=this.index,e=this.uint8array;for(let n=0,o=t.length;n<o;n++)t[n]=Z(e[i+n]);return this.index+=t.byteLength,this.remaining-=t.byteLength,t}readInt16Array(t){if(ArrayBuffer.isView(t)||(t=new Int16Array(t)),this.remaining<t.byteLength)throw new Error(`ByteStream: readInt16Array: premature end - want ${t.byteLength} bytes but have ${this.remaining}`);const i=this.index,e=this.uint8array;for(let n=0,o=t.length;n<o;n++){const s=i+n*2;t[n]=Y(e[s],e[s+1])}return this.index+=t.byteLength,this.remaining-=t.byteLength,t}readInt32Array(t){if(ArrayBuffer.isView(t)||(t=new Int32Array(t)),this.remaining<t.byteLength)throw new Error(`ByteStream: readInt32Array: premature end - want ${t.byteLength} bytes but have ${this.remaining}`);const i=this.index,e=this.uint8array;for(let n=0,o=t.length;n<o;n++){const s=i+n*4;t[n]=Q(e[s],e[s+1],e[s+2],e[s+3])}return this.index+=t.byteLength,this.remaining-=t.byteLength,t}readUint8Array(t){if(ArrayBuffer.isView(t)||(t=new Uint8Array(t)),this.remaining<t.byteLength)throw new Error(`ByteStream: readUint8Array: premature end - want ${t.byteLength} bytes but have ${this.remaining}`);const i=this.index,e=this.uint8array;for(let n=0,o=t.length;n<o;n++)t[n]=e[i+n];return this.index+=t.byteLength,this.remaining-=t.byteLength,t}readUint16Array(t){if(ArrayBuffer.isView(t)||(t=new Uint16Array(t)),this.remaining<t.byteLength)throw new Error(`ByteStream: readUint16Array: premature end - want ${t.byteLength} bytes but have ${this.remaining}`);const i=this.index,e=this.uint8array;for(let n=0,o=t.length;n<o;n++){const s=i+n*2;t[n]=_(e[s],e[s+1])}return this.index+=t.byteLength,this.remaining-=t.byteLength,t}readUint32Array(t){if(ArrayBuffer.isView(t)||(t=new Uint32Array(t)),this.remaining<t.byteLength)throw new Error(`ByteStream: readUint32Array: premature end - want ${t.byteLength} bytes but have ${this.remaining}`);const i=this.index,e=this.uint8array;for(let n=0,o=t.length;n<o;n++){const s=i+n*4;t[n]=J(e[s],e[s+1],e[s+2],e[s+3])}return this.index+=t.byteLength,this.remaining-=t.byteLength,t}readFloat32Array(t){if(ArrayBuffer.isView(t)||(t=new Float32Array(t)),this.remaining<t.byteLength)throw new Error(`ByteStream: readFloat32Array: premature end - want ${t.byteLength} bytes but have ${this.remaining}`);const i=this.index,e=this.uint8array;for(let n=0,o=t.length;n<o;n++){const s=i+n*4;t[n]=m(e[s],e[s+1],e[s+2],e[s+3])}return this.index+=t.byteLength,this.remaining-=t.byteLength,t}readFloat64Array(t){if(ArrayBuffer.isView(t)||(t=new Float64Array(t)),this.remaining<t.byteLength)throw new Error(`ByteStream: readFloat64Array: premature end - want ${t.byteLength} bytes but have ${this.remaining}`);const i=this.index,e=this.uint8array;for(let n=0,o=t.length;n<o;n++){const s=i+n*8;t[n]=tt(e[s],e[s+1],e[s+2],e[s+3],e[s+4],e[s+5],e[s+6],e[s+7])}return this.index+=t.byteLength,this.remaining-=t.byteLength,t}write(t){const i=G(t);return this.writeUint8Array(i),i.length}writeNull(t){const i=this.write(t);return this.index++,this.remaining--,i+1}writeBinary(t){const i=this.index,e=this.uint8array,n=t.length;for(let o=0;o<n;o++)e[i+o]=t.charCodeAt(o);this.index+=n}writeInt8(t){this.uint8array[this.index]=it(t),this.index+=1}writeInt16(t){const i=this.index,e=this.uint8array;et(a,t),e[i]=a[0],e[i+1]=a[1],this.index+=2}writeInt32(t){const i=this.index,e=this.uint8array;nt(a,t),e[i]=a[0],e[i+1]=a[1],e[i+2]=a[2],e[i+3]=a[3],this.index+=4}writeUint8(t){this.uint8array[this.index]=t,this.index+=1}writeUint16(t){const i=this.index,e=this.uint8array;rt(a,t),e[i]=a[0],e[i+1]=a[1],this.index+=2}writeUint32(t){const i=this.index,e=this.uint8array;st(a,t),e[i]=a[0],e[i+1]=a[1],e[i+2]=a[2],e[i+3]=a[3],this.index+=4}writeFloat32(t){const i=this.index,e=this.uint8array;ot(a,t),e[i]=a[0],e[i+1]=a[1],e[i+2]=a[2],e[i+3]=a[3],this.index+=4}writeFloat64(t){const i=this.index,e=this.uint8array;at(a,t),e[i]=a[0],e[i+1]=a[1],e[i+2]=a[2],e[i+3]=a[3],e[i+4]=a[4],e[i+5]=a[5],e[i+6]=a[6],e[i+7]=a[7],this.index+=8}writeInt8Array(t){const i=this.index,e=this.uint8array;for(let n=0,o=t.length;n<o;n++)e[i+n]=it(t[n]);this.index+=t.byteLength}writeInt16Array(t){const i=this.index,e=this.uint8array;for(let n=0,o=t.length;n<o;n++){const s=i+n*2;et(a,t[n]),e[s]=a[0],e[s+1]=a[1]}this.index+=t.byteLength}writeInt32Array(t){const i=this.index,e=this.uint8array;for(let n=0,o=t.length;n<o;n++){const s=i+n*4;nt(a,t[n]),e[s]=a[0],e[s+1]=a[1],e[s+2]=a[2],e[s+3]=a[3]}this.index+=t.byteLength}writeUint8Array(t){const i=this.index,e=this.uint8array;for(let n=0,o=t.length;n<o;n++)e[i+n]=t[n];this.index+=t.byteLength}writeUint16Array(t){const i=this.index,e=this.uint8array;for(let n=0,o=t.length;n<o;n++){const s=i+n*2;rt(a,t[n]),e[s]=a[0],e[s+1]=a[1]}this.index+=t.byteLength}writeUint32Array(t){const i=this.index,e=this.uint8array;for(let n=0,o=t.length;n<o;n++){const s=i+n*4;st(a,t[n]),e[s]=a[0],e[s+1]=a[1],e[s+2]=a[2],e[s+3]=a[3]}this.index+=t.byteLength}writeFloat32Array(t){const i=this.index,e=this.uint8array;for(let n=0,o=t.length;n<o;n++){const s=i+n*4;ot(a,t[n]),e[s]=a[0],e[s+1]=a[1],e[s+2]=a[2],e[s+3]=a[3]}this.index+=t.byteLength}writeFloat64Array(t){const i=this.index,e=this.uint8array;for(let n=0,o=t.length;n<o;n++){const s=i+n*8;at(a,t[n]),e[s]=a[0],e[s+1]=a[1],e[s+2]=a[2],e[s+3]=a[3],e[s+4]=a[4],e[s+5]=a[5],e[s+6]=a[6],e[s+7]=a[7]}this.index+=t.byteLength}}class lt{buffer;index=0;ident=0;indentSpaces=4;precision=1e6;constructor(t){this.buffer=t||""}clear(){this.buffer="",this.index=0,this.ident=0}readToken(){const t=this.buffer,i=t.length;let e=!1,n=!1,o="";for(;this.index<i;){const s=t[this.index++];if(e)s===`
