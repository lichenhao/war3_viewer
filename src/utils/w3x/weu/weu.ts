...
import parseWtg from './parsewtg.js';
import WeuData, { WEUChange } from './data.js';
import { processTrigger } from './processing.js';
import { convertTrigger } from './conversions.js';
