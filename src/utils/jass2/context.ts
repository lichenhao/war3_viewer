...
import JassPlayer from './types/player.js';
import constantHandles from './constanthandles.js';
import Thread from './thread.js';
import JassHandle from './types/handle.js';
import JassLocation from './types/location.js';
import JassTimer from './types/timer.js';
import { JassTrigger } from './types/index.js';
