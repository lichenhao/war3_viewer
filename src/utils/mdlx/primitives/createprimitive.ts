...
import MdlxTexture from '../../../parsers/mdlx/texture.js';
import MdlxMaterial from '../../../parsers/mdlx/material.js';
import MdlxLayer, { Flags } from '../../../parsers/mdlx/layer.js';
import MdlxGeoset from '../../../parsers/mdlx/geoset.js';
import MdlxGeosetAnimation from '../../../parsers/mdlx/geosetanimation.js';
import MdlxBone from '../../../parsers/mdlx/bone.js';
import ModelViewer from '../../../viewer/viewer.js';
import Texture from '../../../viewer/texture.js';
import { PathSolver } from '../../../viewer/handlerresource.js';
import MdxModel from '../../../viewer/handlers/mdx/model.js';
