...
import { lerp, hermite, bezier } from '../../../common/math.js';
import { Animation, UintAnimation, FloatAnimation, Vector3Animation, InterpolationType } from '../../../parsers/mdlx/animations.js';
