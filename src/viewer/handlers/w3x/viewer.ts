import { FetchDataTypeName } from '../../../common/fetchdatatype.js';
import { MappedData } from '../../../utils/mappeddata.js';
import ModelViewer from '../../viewer.js';
import Shader from '../../gl/shader.js';
import { PathSolver } from '../../handlerresource.js';
import mdxHandler from '../mdx/handler.js';
import blpHandler from '../blp/handler.js';
import tgaHandler from '../tga/handler.js';
import ddsHandler from '../dds/handler.js';
import groundVert from './shaders/ground.vert.js';
import groundFrag from './shaders/ground.frag.js';
import waterVert from './shaders/water.vert.js';
import waterFrag from './shaders/water.frag.js';
import cliffsVert from './shaders/cliffs.vert.js';
import cliffsFrag from './shaders/cliffs.frag.js';
