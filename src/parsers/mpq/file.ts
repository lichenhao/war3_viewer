...
import MpqArchive from './archive.js';
import MpqBlock from './block.js';
import { COMPRESSION_ADPCM_MONO, COMPRESSION_ADPCM_STEREO, COMPRESSION_BZIP2, COMPRESSION_DEFLATE, COMPRESSION_HUFFMAN, COMPRESSION_IMPLODE, FILE_COMPRESSED, FILE_ENCRYPTED, FILE_EXISTS, FILE_IMPLODE, FILE_OFFSET_ADJUSTED_KEY, FILE_SINGLE_UNIT, HASH_ENTRY_DELETED } from './constants.js';
import MpqCrypto from './crypto.js';
import explode from './explode.js';
// import decodeHuffman from './huffman.js';
import MpqHash from './hash.js';
import { isArchive } from './isarchive.js';
